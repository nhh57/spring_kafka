...
- [x] Nhiệm vụ 3: Viết unit test cho Kafka Streams với `TopologyTestDriver`. (Đã hoàn thành)
...
- [x] Nhiệm vụ 7: Giới thiệu và minh họa Single Message Transforms (SMTs). (Đã hoàn thành)
