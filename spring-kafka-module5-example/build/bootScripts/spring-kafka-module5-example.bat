...
set JARPATH=%APP_HOME%\lib\spring-kafka-module5-example-0.0.1-SNAPSHOT.jar

@rem Execute spring-kafka-module5-example
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SPRING_KAFKA_MODULE5_EXAMPLE_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%SPRING_KAFKA_MODULE5_EXAMPLE_EXIT_CONSOLE%" exit 1
exit /b 1
